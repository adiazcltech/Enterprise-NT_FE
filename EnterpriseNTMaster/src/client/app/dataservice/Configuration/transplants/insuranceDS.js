(function () {
    ...
    angular
        .module('app.core')
        .factory('insuranceDS', insuranceDS);
    insuranceDS.$inject = ['$http', 'settings'];

    //** Método que define los metodos a usar*/
    function insuranceDS($http, settings) {
        var service = {
            get: get,
            getId: getId,
            New: New,
        ...
        function get(token) {
            var promise = $http({
                ...
                url: settings.serviceUrl + '/insurance'
        ...
        function getId(token, id) {
            var promise = $http({
                method: 'GET',
                headers: { 'Authorization': token },
                url: settings.serviceUrl + '/insurance/' + id
